...
## HOTSPOTS
- tools/output/project_dump.md: 4541 LOC
- tools/output/project_dump_full.md: 4541 LOC
- tools/output/project_dump_ai.md: 3937 LOC
- docker-compose.yml: 223 LOC
- .github/workflows/deploy.yml: 222 LOC
- tools/stats.py: 184 LOC
- README.md: 178 LOC
- tests/api/test_repair_requests.py: 172 LOC
- tools/README.md: 171 LOC
